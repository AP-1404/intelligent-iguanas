...
const PRIVACY_CARDS = [
  ...
  },
  {
    ...
    desc: 'You can leave the group, block participants, or report a problem through WhatsApp at any time. You can report any privacy related issues to admins at any time.',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
